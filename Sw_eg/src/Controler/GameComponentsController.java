...
/**
 * This class represents the Model made up of separate components in Backgammon.
 * This class creates a Model made out of modular panes/nodes.
 * 
 * @teamname TeaCup
...
public class GameComponentsController extends VBox {
	...
	/**
	 * Default Constructor
	 * 		- Initializes the modular Model components.
	 */
	...
	/**
	 * Initializes the Model by creating the components and putting them together.
	 * i.e. initializing the Model layout.
	 */
	...
	// used exclusively to reset after each match, not each Model.
