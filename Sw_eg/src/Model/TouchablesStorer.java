...
/**
 * This class should be extended by Model components (bar, home, pips) that will store checkers.
 * This class has all the common functions that will be needed by Model components to draw checkers.
