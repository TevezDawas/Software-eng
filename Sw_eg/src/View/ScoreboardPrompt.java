...
public class ScoreboardPrompt extends GridPane {
	 ...
	 * depending on context (start/end Model).
	 * Note: End of Model requires passing in the correct players for their scores.
	 */
	 ...
	 * Note: End of Model requires passing in the correct players.
	 */
	...
	private ImageView getCheckerImg(String string) {
		return new ImageView(this.getClass().getResource("/Model/img/checkers/" 
	 ...
	 * 		- player names are TextFields/Labels, depending on start/end Model.
	 */
