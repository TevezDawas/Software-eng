...
/**
 * A TextFlow contained in a ScrollPane that displays the status of the Model.
 * 
 * @teamname TeaCup
...
public class InfoPanel extends ScrollPane {
	...
	/**
	 * Outputs welcome message and prompts player to start Model
	 */
	public void welcome() {
		print("Welcome to Backgammon!");
		print("Enter \"/start\" below to start a new Model.");
